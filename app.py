...
WEBHOOK_DOMAIN = os.getenv("WEBHOOK_DOMAIN")  # Пример: https://yordamchybot.onrender.com
WEBHOOK_PATH = os.getenv("WEBHOOK_PATH", "/webhook")  # Обычно: /webhook
PORT = int(os.environ.get("PORT", 10000))  # Render задаёт порт через эту переменную
